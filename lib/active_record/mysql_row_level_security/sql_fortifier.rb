...
module ActiveRecord
  module MysqlRowLevelSecurity
    class SqlFortifier
      ...
      def initialize(sql:, configuration: ActiveRecord::MysqlRowLevelSecurity.configuration)
        @original_sql = sql
    ...
    class SqlFingerPrinter
      ...
      def sql
        @sql ||= stamped_sql.extend(ActiveRecord::MysqlRowLevelSecurity::SqlFingerPrinter::Stamp)
      end
