...
Gem::Specification.new do |spec|
  spec.name          = "mysql_row_guard"
  spec.version       = MysqlRowGuard::VERSION
  spec.authors       = ["tleish"]
  ...
  spec.homepage      = "https://github.com/tleish/mysql_row_guard"
  spec.license       = "MIT"
  ...
  if spec.respond_to?(:metadata)
    ...
    spec.metadata["source_code_uri"] = 'https://github.com/tleish/mysql_row_guard'
    spec.metadata["changelog_uri"] = 'https://github.com/tleish/mysql_row_guard'
  else
